...
fn wire__crate__api_dart__impact__ImpactDetectorDart_corroborate_dv_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "ImpactDetectorDart_corroborate_dv",
            port: None,
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Sync,
        },
        move || {
            ...
            let api_that = <RustOpaqueMoi<
                flutter_rust_bridge::for_generated::RustAutoOpaqueInner<ImpactDetectorDart>,
            >>::sse_decode(&mut deserializer);
            let api_speed_after_mps = <f64>::sse_decode(&mut deserializer);
            let api_now_ms = <i64>::sse_decode(&mut deserializer);
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let mut api_that_guard = None;
                ...
                let api_that_guard = api_that_guard.unwrap();
                let output_ok = Result::<_, ()>::Ok(
                    crate::api_dart::impact::ImpactDetectorDart::corroborate_dv(
                        &*api_that_guard,
                        api_speed_after_mps,
                        api_now_ms,
                    ),
...
fn wire__crate__api_dart__impact__ImpactDetectorDart_on_impact_window_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            let api_post_impact_still = <bool>::sse_decode(&mut deserializer);
