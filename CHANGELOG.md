...
Packages with other changes:
 ...
 - [`tracelet_android` - `v3.4.2`](#tracelet_android---v350)
 - [`tracelet_ios` - `v3.4.2`](#tracelet_ios---v350)
 - [`tracelet_sync` - `v3.4.2`](#tracelet_sync---v350)
...
Packages with other changes:
 ...
 - [`tracelet` - `v3.4.0`](#tracelet---v335)
 - [`tracelet_android` - `v3.4.0`](#tracelet_android---v335)
 - [`tracelet_ios` - `v3.4.0`](#tracelet_ios---v335)
 - [`tracelet_platform_interface` - `v3.4.0`](#tracelet_platform_interface---v335)
 - [`tracelet_sync` - `v3.4.0`](#tracelet_sync---v335)
 - [`tracelet_doctor` - `v3.4.0`](#tracelet_doctor---v335)
 - [`tracelet_supabase` - `v3.4.0`](#tracelet_supabase---v335)
 - [`tracelet_firebase` - `v3.4.0`](#tracelet_firebase---v335)
 - [`tracelet_web` - `v3.4.0`](#tracelet_web---v335)

Packages with dependency updates only:

> Packages listed below depend on other packages in this workspace that have had changes. Their versions have been incremented to bump the minimum dependency versions of the packages they depend upon in this project.

 - `tracelet_sync` - `v3.4.0`
 - `tracelet_doctor` - `v3.4.0`
 - `tracelet_supabase` - `v3.4.0`
 - `tracelet_firebase` - `v3.4.0`
 - `tracelet_web` - `v3.4.0`
...
#### `tracelet_platform_interface` - `v3.4.0`
