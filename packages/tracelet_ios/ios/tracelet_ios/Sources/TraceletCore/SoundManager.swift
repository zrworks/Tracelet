...
public final class SoundManager {
    ...
    public func playGeofence(action: String) {
        guard configManager.isDebug() else { return }
        switch action {
        case "ENTER":
    ...
    public func playHttpResult(success: Bool) {
        guard configManager.isDebug() else { return }
        if success {
