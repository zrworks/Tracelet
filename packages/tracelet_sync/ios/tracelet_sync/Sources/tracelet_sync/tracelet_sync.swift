...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_tracelet_sync_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_tracelet_sync_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureTraceletSyncInitialized()
...
public protocol SyncManagerProtocol: AnyObject, Sendable {
     ...
     */
    func syncBatchBlocking(config: SyncHttpConfig, records: [SyncLocationRecord]) throws  -> UInt32
...
open class SyncManager: SyncManagerProtocol, @unchecked Sendable {
    ...
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_tracelet_sync_fn_clone_syncmanager(self.handle, $0) }
    }
public convenience init() {
    let handle =
        try! rustCall() {
    uniffi_tracelet_sync_fn_constructor_syncmanager_new($0
    )
}
    ...
    deinit {
        ...
        try! rustCall { uniffi_tracelet_sync_fn_free_syncmanager(handle, $0) }
    }
     ...
     * Returns the number of successfully synced records.
     */
open func syncBatchBlocking(config: SyncHttpConfig, records: [SyncLocationRecord])throws  -> UInt32  {
    return try  FfiConverterUInt32.lift(try rustCallWithError(FfiConverterTypeTraceletError_lift) {
    uniffi_tracelet_sync_fn_method_syncmanager_sync_batch_blocking(
            self.uniffiCloneHandle(),
        FfiConverterTypeSyncHttpConfig_lower(config),
        FfiConverterSequenceTypeSyncLocationRecord.lower(records),$0
    )
})
}
...
public struct SyncHttpConfig: Equatable, Hashable {
...
#if compiler(>=6)
extension SyncHttpConfig: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeSyncHttpConfig: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SyncHttpConfig {
        return
            try SyncHttpConfig(
    ...
    public static func write(_ value: SyncHttpConfig, into buf: inout [UInt8]) {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeSyncHttpConfig_lift(_ buf: RustBuffer) throws -> SyncHttpConfig {
    return try FfiConverterTypeSyncHttpConfig.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeSyncHttpConfig_lower(_ value: SyncHttpConfig) -> RustBuffer {
    return FfiConverterTypeSyncHttpConfig.lower(value)
}


public struct SyncLocationRecord: Equatable, Hashable {
    public var id: Int64
...
#if compiler(>=6)
extension SyncLocationRecord: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeSyncLocationRecord: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SyncLocationRecord {
        return
            try SyncLocationRecord(
    ...
    public static func write(_ value: SyncLocationRecord, into buf: inout [UInt8]) {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeSyncLocationRecord_lift(_ buf: RustBuffer) throws -> SyncLocationRecord {
    return try FfiConverterTypeSyncLocationRecord.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeSyncLocationRecord_lower(_ value: SyncLocationRecord) -> RustBuffer {
    return FfiConverterTypeSyncLocationRecord.lower(value)
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterSequenceTypeSyncLocationRecord: FfiConverterRustBuffer {
    typealias SwiftType = [SyncLocationRecord]

    public static func write(_ value: [SyncLocationRecord], into buf: inout [UInt8]) {
        let len = Int32(value.count)
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypeSyncLocationRecord.write(item, into: &buf)
        }
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [SyncLocationRecord] {
        let len: Int32 = try readInt(&buf)
        var seq = [SyncLocationRecord]()
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeSyncLocationRecord.read(from: &buf))
        }
        return seq
    }
}
...
public func encodeDeltas(batchJson: String, precision: Int32) -> String  {
    ...
    uniffi_tracelet_sync_fn_func_encode_deltas(
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_tracelet_sync_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if (uniffi_tracelet_sync_checksum_func_encode_deltas() != 5602) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_tracelet_sync_checksum_method_syncmanager_sync_batch_blocking() != 33021) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_tracelet_sync_checksum_constructor_syncmanager_new() != 42810) {
        return InitializationResult.apiChecksumMismatch
    }
...
public func uniffiEnsureTraceletSyncInitialized() {
