...
void main() {
  ...
  testWidgets(
    'TraceletSync HTTP Root Property and Params regression test on iOS',
    (tester) async {
      ...
      expect(
        payload.containsKey('location_data'),
        isTrue,
        reason: 'httpRootProperty should be location_data',
      );
      ...
      expect(
        ...
        isTrue,
        reason: 'params object should exist',
      );
      expect(payload['params']['user_id'], 'ikolvi_tester');
      expect(payload['params']['device'], 'example_app');

      expect(
        payload.containsKey('extras'),
        isTrue,
        reason: 'extras object should exist',
      );
