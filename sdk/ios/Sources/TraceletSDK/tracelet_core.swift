...
public protocol ImpactDetectorProtocol: AnyObject, Sendable {
     ...
     */
    func onImpactWindow(peakG: Double, speedBeforeMps: Double, gyroPeakDps: Double, isOnFoot: Bool, latitude: Double, longitude: Double, nowMs: Int64)  -> ImpactEvent?
...
open func confirm(id: Int64, nowMs: Int64) -> ImpactEvent?  {
     ...
     * confirmation), else `None`.
     */
open func onImpactWindow(peakG: Double, speedBeforeMps: Double, gyroPeakDps: Double, isOnFoot: Bool, latitude: Double, longitude: Double, nowMs: Int64) -> ImpactEvent?  {
    return try!  FfiConverterOptionTypeImpactEvent.lift(try! rustCall() {
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_tracelet_core_checksum_method_impactdetector_on_impact_window() != 64785) {
        return InitializationResult.apiChecksumMismatch
    }
