...
- **Battery budget** — set `batteryBudgetPerHour` (e.g. `3.0` for 3%/hr). Tracelet then auto-adjusts `distanceFilter` and `desiredAccuracy` at runtime to stay under that target.
