...
5. **Link the SDK to your Widget:** Because your widget needs to use the SDK's exact Activity types, you must link it.
   - In Xcode, select your new `TraceletWidgetExtension` target.
   - Go to **General** -> **Frameworks and Libraries**.
   - Click the **+** button, select `FlutterGeneratedPluginSwiftPackage` (or `TraceletSDK`), and click **Add**.
6. Replace the auto-generated `TraceletWidgetLiveActivity.swift` content with the following:
