...
external fun uniffi_tracelet_core_checksum_method_crashmodel_feature_names(
): Short
external fun uniffi_tracelet_core_checksum_method_crashmodel_is_crash(
): Short
external fun uniffi_tracelet_core_checksum_method_crashmodel_predict_proba(
): Short
external fun uniffi_tracelet_core_checksum_method_crashmodel_tree_count(
): Short
...
external fun uniffi_tracelet_core_checksum_constructor_crashmodel_from_encrypted(
): Short
external fun uniffi_tracelet_core_checksum_constructor_crashmodel_from_json(
): Short
...
internal object UniffiLib {
    ...
    external fun uniffi_tracelet_core_fn_clone_crashmodel(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Long
external fun uniffi_tracelet_core_fn_free_crashmodel(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Unit
external fun uniffi_tracelet_core_fn_constructor_crashmodel_from_encrypted(`blob`: RustBuffer.ByValue,`key`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): Long
external fun uniffi_tracelet_core_fn_constructor_crashmodel_from_json(`json`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): Long
external fun uniffi_tracelet_core_fn_method_crashmodel_feature_names(`ptr`: Long,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
external fun uniffi_tracelet_core_fn_method_crashmodel_is_crash(`ptr`: Long,`features`: RustBuffer.ByValue,`threshold`: Double,uniffi_out_err: UniffiRustCallStatus, 
): Byte
external fun uniffi_tracelet_core_fn_method_crashmodel_predict_proba(`ptr`: Long,`features`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): Double
external fun uniffi_tracelet_core_fn_method_crashmodel_tree_count(`ptr`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Int
...
external fun uniffi_tracelet_core_fn_method_impactdetector_on_impact_window(`ptr`: Long,`peakG`: Double,`speedBeforeMps`: Double,`gyroPeakDps`: Double,`wasInFreeFall`: Byte,`isOnFoot`: Byte,`latitude`: Double,`longitude`: Double,`nowMs`: Long,`crashProba`: Double,`crashProbaThreshold`: Double,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    ...
    if (lib.uniffi_tracelet_core_checksum_method_crashmodel_feature_names() != 11927.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_tracelet_core_checksum_method_crashmodel_is_crash() != 128.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_tracelet_core_checksum_method_crashmodel_predict_proba() != 43111.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_tracelet_core_checksum_method_crashmodel_tree_count() != 12953.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_tracelet_core_checksum_method_impactdetector_on_impact_window() != 41797.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
 ...
 */
public interface CrashModelInterface {
    
    /**
     * Ordered feature names the model expects (the host must supply `predict`
     * values in this exact order).
     */
    fun `featureNames`(): List<kotlin.String>
    
    /**
     * Convenience: `predict_proba(features) >= threshold`.
     */
    fun `isCrash`(`features`: List<kotlin.Double>, `threshold`: kotlin.Double): kotlin.Boolean
     ...
     */
    fun `predictProba`(`features`: List<kotlin.Double>): kotlin.Double
    
    /**
     * Number of trees (diagnostics).
     */
    fun `treeCount`(): kotlin.UInt
 ...
 * On-device crash classifier (random-forest tree-walker).
 */
open class CrashModel: Disposable, AutoCloseable, CrashModelInterface
{
    ...
    private class UniffiCleanAction(private val handle: Long) : Runnable {
        override fun run() {
            ...
            uniffiRustCall { status ->
                UniffiLib.uniffi_tracelet_core_fn_free_crashmodel(handle, status)
            }
        }
    }
    ...
    fun uniffiCloneHandle(): Long {
        ...
        return uniffiRustCall() { status ->
            UniffiLib.uniffi_tracelet_core_fn_clone_crashmodel(handle, status)
        }
    }
     ...
     * Ordered feature names the model expects (the host must supply `predict`
     * values in this exact order).
     */override fun `featureNames`(): List<kotlin.String> {
            return FfiConverterSequenceString.lift(
    callWithHandle {
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_tracelet_core_fn_method_crashmodel_feature_names(
        it,
        _status)
}
    }
    ...
    /**
     * Convenience: `predict_proba(features) >= threshold`.
     */override fun `isCrash`(`features`: List<kotlin.Double>, `threshold`: kotlin.Double): kotlin.Boolean {
            return FfiConverterBoolean.lift(
    callWithHandle {
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_tracelet_core_fn_method_crashmodel_is_crash(
        it,
        FfiConverterSequenceDouble.lower(`features`),FfiConverterDouble.lower(`threshold`),_status)
}
    }
    )
    }
     ...
     * averaged across all trees. `features` must be in [`feature_names`] order;
     * a wrong length returns `0.0` (never panics on the hot path).
     */override fun `predictProba`(`features`: List<kotlin.Double>): kotlin.Double {
            return FfiConverterDouble.lift(
    callWithHandle {
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_tracelet_core_fn_method_crashmodel_predict_proba(
        it,
        FfiConverterSequenceDouble.lower(`features`),_status)
}
    }
    )
    }
    ...
    /**
     * Number of trees (diagnostics).
     */override fun `treeCount`(): kotlin.UInt {
            return FfiConverterUInt.lift(
    callWithHandle {
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_tracelet_core_fn_method_crashmodel_tree_count(
        it,
        _status)
}
    }
     ...
     */
    @Throws(TraceletException::class) fun `fromEncrypted`(`blob`: kotlin.ByteArray, `key`: kotlin.ByteArray): CrashModel {
            return FfiConverterTypeCrashModel.lift(
    uniffiRustCallWithError(TraceletException) { _status ->
    UniffiLib.uniffi_tracelet_core_fn_constructor_crashmodel_from_encrypted(
    
        FfiConverterByteArray.lower(`blob`),FfiConverterByteArray.lower(`key`),_status)
}
    )
    }
    ...
    @Throws(TraceletException::class) fun `fromJson`(`json`: kotlin.String): CrashModel {
            return FfiConverterTypeCrashModel.lift(
    uniffiRustCallWithError(TraceletException) { _status ->
    UniffiLib.uniffi_tracelet_core_fn_constructor_crashmodel_from_json(
 ...
 * @suppress
 */
public object FfiConverterTypeCrashModel: FfiConverter<CrashModel, Long> {
    override fun lower(value: CrashModel): Long {
        return value.uniffiCloneHandle()
    }

    override fun lift(value: Long): CrashModel {
        return CrashModel(UniffiWithHandle, value)
    }

    override fun read(buf: ByteBuffer): CrashModel {
        return lift(buf.getLong())
    }

    override fun allocationSize(value: CrashModel) = 8UL

    override fun write(value: CrashModel, buf: ByteBuffer) {
        buf.putLong(lower(value))
    }
}
...
public interface ImpactDetectorInterface {
     ...
     */
    fun `onImpactWindow`(`peakG`: kotlin.Double, `speedBeforeMps`: kotlin.Double, `gyroPeakDps`: kotlin.Double, `wasInFreeFall`: kotlin.Boolean, `isOnFoot`: kotlin.Boolean, `latitude`: kotlin.Double, `longitude`: kotlin.Double, `nowMs`: kotlin.Long, `crashProba`: kotlin.Double, `crashProbaThreshold`: kotlin.Double): ImpactEvent?
...
open class ImpactDetector: Disposable, AutoCloseable, ImpactDetectorInterface
{
     ...
     * `potential_*` event when an impact is detected (and registers it for
     * confirmation), else `None`.
     */override fun `onImpactWindow`(`peakG`: kotlin.Double, `speedBeforeMps`: kotlin.Double, `gyroPeakDps`: kotlin.Double, `wasInFreeFall`: kotlin.Boolean, `isOnFoot`: kotlin.Boolean, `latitude`: kotlin.Double, `longitude`: kotlin.Double, `nowMs`: kotlin.Long, `crashProba`: kotlin.Double, `crashProbaThreshold`: kotlin.Double): ImpactEvent? {
            return FfiConverterOptionalTypeImpactEvent.lift(
    callWithHandle {
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_tracelet_core_fn_method_impactdetector_on_impact_window(
        it,
        FfiConverterDouble.lower(`peakG`),FfiConverterDouble.lower(`speedBeforeMps`),FfiConverterDouble.lower(`gyroPeakDps`),FfiConverterBoolean.lower(`wasInFreeFall`),FfiConverterBoolean.lower(`isOnFoot`),FfiConverterDouble.lower(`latitude`),FfiConverterDouble.lower(`longitude`),FfiConverterLong.lower(`nowMs`),FfiConverterDouble.lower(`crashProba`),FfiConverterDouble.lower(`crashProbaThreshold`),_status)
}
    }
    )
    }
