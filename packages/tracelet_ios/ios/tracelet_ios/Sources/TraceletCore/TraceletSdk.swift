...
public final class TraceletSdk {
    ...
    internal private(set) var configManager: ConfigManager!
    internal private(set) var stateManager: StateManager!
    internal private(set) var database: TraceletDatabase!
    internal private(set) var locationEngine: LocationEngine!
    internal private(set) var motionDetector: MotionDetector!
    internal private(set) var geofenceManager: GeofenceManager!
    internal private(set) var httpSyncManager: HttpSyncManager!
    internal private(set) var scheduleManager: ScheduleManager!
    internal private(set) var logger: TraceletLogger!
    internal private(set) var soundManager: SoundManager!
    internal private(set) var permissionManager: TraceletPermissionManager!
    internal private(set) var auditTrailManager: AuditTrailManager!
    internal private(set) var privacyZoneManager: PrivacyZoneManager!
    internal private(set) var deviceAttestor: DeviceAttestor!
    internal private(set) var preventSuspendManager: PreventSuspendManager!
    internal private(set) var backgroundActivitySessionManager: BackgroundActivitySessionManager!
    internal private(set) var serviceSessionManager: ServiceSessionManager!
    internal private(set) var periodicRefreshScheduler: PeriodicRefreshScheduler!
