...
<LottiePlayer src="/animations/android.json" maxWidth="300px" minHeight="200px" />
...
<Callout type="info" emoji="🔔">
  **Android 13+ Note:** You must request the `POST_NOTIFICATIONS` permission before starting the service, otherwise the notification will be silently suppressed by the OS. See the [Flutter SDK: Permissions](/en/getting-started/flutter#scenario-2-the-onboarding-flow) page for exactly how to request this from your Dart code.
</Callout>
...
For a detailed example of how to implement this in your Flutter UI, see the [Diagnostic Tools & Power Management](/en/reference/tools#oem-power-manager-settings-health) page.
